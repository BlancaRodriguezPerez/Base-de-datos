...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-12-2018 a las 05:52:50
...
--
ALTER TABLE `cuestionario_contestado`
  MODIFY `IdCuestionarioContestado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `reactivos`
  MODIFY `IdReactivo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT de la tabla `respuestas`
--
ALTER TABLE `respuestas`
  MODIFY `IdRespuesta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT de la tabla `respuesta_campo`
--
ALTER TABLE `respuesta_campo`
  MODIFY `idRespuestaCampo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
